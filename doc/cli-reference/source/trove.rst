...
``reset-status``
  Set the task status of an instance to NONE
  if the instance is in BUILD
...
Set the task status of an instance to NONE if the instance is in BUILD or
ERROR state. Resetting task status of an instance in BUILD state will allow
